...
// Hidden until the engine has drawn a real frame (data-ready), then shown
// instantly — the gate exists only to mask pre-first-frame canvas garbage,
// not to animate an entrance.
export const shaderCanvas =
  "block h-full w-full opacity-0 data-[ready=true]:opacity-100";
...
export const footerMeta =
  "mt-14 flex flex-wrap justify-between gap-5 pt-6 font-mono text-[11.5px] tracking-[0.04em] text-fg-4 [&_a]:text-fg-3 [&_a:hover]:text-accent";
