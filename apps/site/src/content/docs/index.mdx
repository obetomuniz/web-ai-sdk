...
- **Start**: shared concepts, browser support, production guidance, architecture, and the public [MCP server](/docs/mcp/).
...
- [MCP server](/docs/mcp/): connect an agent to canonical project documentation.
