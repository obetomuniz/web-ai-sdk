---
title: Translator
description: Building block for the Web's Built-in Translator. String-mode translation with pair-cached sessions and opt-in result caching.
---
...
| `cacheKey` | `string` | Override the default cache key (hash of `{ sourceLanguage, targetLanguage, input }`). |
