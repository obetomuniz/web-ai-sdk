...
String compatibility is temporary. Remove it when supported trial generations no longer require it. Registration continues to accept schema objects; the separate native execution-input transition is outside this discovery change.
