...
pnpm add web-ai-sdk                # all five blocks
```

See the [meta-package guide](./guides/meta-package/) for the two import shapes (`web-ai-sdk/prompt` subpath vs `{ prompt } from "web-ai-sdk"` namespaced root).
