...
// web-ai-sdk.dev deploy. Run as a postbuild step after `vite build` so the
// files land in apps/landing/dist/ and are picked up by the Pages assemble
// step (`_site/`).
//
// Inputs:
//   - packages/*/README.md             (source of truth for llms content)
//   - apps/docs/src/content/docs/**    (route enumeration for sitemap)
// Outputs:
//   - apps/landing/dist/llms.txt
//   - apps/landing/dist/llms-full.txt
//   - apps/landing/dist/sitemap.xml
//
...
const DOCS_CONTENT_DIR = resolve(REPO_ROOT, "apps/docs/src/content/docs");
