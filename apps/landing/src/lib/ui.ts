...
export const textarea =
  "min-h-[88px] w-full resize-y rounded-sm border border-hairline bg-bg px-3 py-2.5 font-mono text-[13px] leading-[1.5] text-fg transition-[border-color,background] focus:border-accent-line focus:bg-surface-2 focus:outline-none";
