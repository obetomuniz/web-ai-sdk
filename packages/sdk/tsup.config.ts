...
export default defineConfig({
  entry: {
    ...
    rewriter: "src/rewriter.ts",
    proofreader: "src/proofreader.ts",
    ...
    "react/writer": "src/react/writer.ts",
    "react/rewriter": "src/react/rewriter.ts",
    "react/proofreader": "src/react/proofreader.ts",
  },
  format: ["esm", "cjs"],
  dts: true,
  clean: true,
