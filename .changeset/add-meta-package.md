...
Introduce `web-ai-sdk`, a meta-package that re-exports the five `@web-ai-sdk/*` building blocks (`prompt`, `summarizer`, `translator`, `detector`, `webmcp`) behind a single install. Two import shapes are supported:
